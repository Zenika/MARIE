...
func DoAll(id string, thingType string, action string, params []thing.Parameter) {
...
func DoLocation(id string, thingType string, location string, action string, params []thing.Parameter) {
	for _, p := range protocols {
...
func DoMacAddress(id string, macaddress string, action string, params []thing.Parameter) {
	for _, p := range protocols {
